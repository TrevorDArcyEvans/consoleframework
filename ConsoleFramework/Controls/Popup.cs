...
namespace ConsoleFramework.Controls
{
  internal class Popup : Window
  {
    ...
    /// Первые _width пикселей в ней - непрозрачные для событий мыши, но при клике на них
    /// окно закрывается вызовом Close(). Остальные ActualWidth - _width пикселей - прозрачные
    ...
    public override void Render(RenderingBuffer buffer)
    {
      ...
      // Первые _width пикселей первой строки - прозрачные, но события мыши не пропускают
