...
namespace ConsoleFramework.Native
{
  ...
  public static class Win32
  {
    ...
    [DllImport("kernel32.dll", ExactSpelling = true, SetLastError = true)]
    public static extern IntPtr GetStdHandle([MarshalAs(UnmanagedType.I4)]
      StdHandleType nStdHandle);
    ...
    public static extern bool ReadConsoleInput(IntPtr hConsoleInput, [Out]
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    public static extern bool SetConsoleCursorInfo(IntPtr hConsoleOutput, [In]
